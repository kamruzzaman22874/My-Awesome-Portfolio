	...
	return (
			<div className='hidden lg:flex fixed flex-col top-[40%] right-0'>
				<ul className='text-gray-300'>
					<li className='w-[160px] h-[60px] flex justify-between items-center mr-[-100px] hover:mr-[-10px] duration-300 bg-blue-600 p-4 my-2'>
						<Link
							to='home'
							smooth={true}
							duration={500}
					...
					<li className='w-[160px] h-[60px] flex justify-between items-center mr-[-100px]  duration-300 bg-[#333333] p-4 my-2'>
						<Link
							to='about'
							smooth={true}
							duration={500}
					...
					<li className='w-[160px] h-[60px] flex justify-between items-center mr-[-100px]  duration-300 bg-[#565f69] p-4 my-2'>
						<Link
							to='work'
							smooth={true}
							duration={500}
